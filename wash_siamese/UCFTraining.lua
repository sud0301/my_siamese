...
cmd:option('-saveFile','net_wash20_10_2308.t7','Location for logging') -- to load: p = torch.load('test.t7')

cmd:option('-model', 'vgg_bn_drop_v3', 'model name')
cmd:option('-modelFile', 'net_wash20_10_2308_net.t7', 'model file name')
